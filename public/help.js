...
export const HELP = {
  ...
  "rig.redraw": "リグ合成の結果を「ポーズの設計図」として、線・シェーディング・ディテールをベースフレームに合わせてAIが描き直します。描き込みの多いキャラで機械回転が破綻するときの本命です。仕上げにAI清書を掛けるのが推奨ルートです。",
  "rig.redrawMoved": "ベースから変化したセルの周囲5px+移動したパーツの矩形だけを描き直します。速くて安全な既定です。",
  "rig.redrawFull": "キャラの非透明範囲全体を描き直します。ポーズ変化が大きく「動いた部位のみ」では継ぎ目が残るときに使ってください（時間はかかります）。",
